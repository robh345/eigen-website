...
<div>
    <div class="container">
        <br>
        <div class="rounded-circle row justify-content-center">
            <div>
                <img src="img/Rob.jpg" class="rounded-circle">
            </div>
        </div>
        <br>
        <div class="text-light">
            <div class="rounded bg-dark card-body row justify-content-center">
                <div class="col-8">
                    <h1 class="text-center"><?php contentomsch(1); ?></h1>
                    <p class="text-center"><?php selectcontent(1); ?></p>
                </div>
            </div>
        </div>
    </div>
